...
public class Element : ObjectGst
{
	 ...
	 */
	public int queryConvert(GstFormat srcFormat, long srcVal, ref GstForma destFormat, long* destVal)
	{
	 ...
	 * Returns: TRUE if the query could be performed.
	 */
	public int queryPosition(ref GstForma format, ref long cur)
	{
	 ...
	 * Returns: TRUE if the query could be performed.
	 */
	public int queryDuration(ref GstForma format, ref long duration)
	{
